...
public class RewardsController : ControllerBase
{
    ...
    public async Task<IActionResult> PurchaseReward(long id, CancellationToken cancellationToken)
    {
        ...
        return result.Status switch
        {
            ...
            RewardPurchaseStatus.DatabaseConfigurationMissing => StatusCode(StatusCodes.Status500InternalServerError, new { code = "database_configuration_missing", message = "De rewards-backend is niet volledig geconfigureerd." }),
